        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 pb-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div style={{
              ...
              <p style={{ fontWeight: 700 }}>© Universitas Indonesia Women in Business (UIWIB)</p>
              <p>UIWIB is an independent student-run organization at Universitas Indonesia</p>
            </div>
            <p style={{
              fontFamily: "TTCommons, sans-serif",
              fontSize: "clamp(0.75rem, 1.1vw, 0.9rem)",
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3 mt-1">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/universitas-indonesia-women-in-business/?originalSubdomain=id" aria-label="LinkedIn" style={{ color: "#FFF5E1" }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
